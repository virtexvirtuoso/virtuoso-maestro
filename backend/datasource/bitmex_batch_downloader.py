...
from datasource.bitmex_batch_downloader_worker import BitMexBatchDownloaderWorker
from logger.logger_builder import LoggerBuilder


class BitMexBatchDownloader:
    ...
    def __init__(self, storage: StorageLayer, logger: logging.Logger = None):
        ...
        self.provider = DataSourceProviders.BITMEX
